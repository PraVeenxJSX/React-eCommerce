        ...
        {firstFiveImages.map((item, idx) => (
          ...
          >
            ...
            <div style={{width: '100%', textAlign: 'center'}}>
              <h3 style={{fontSize: '1.1rem', fontWeight: 700, color: '#4f46e5', margin: '8px 0 4px 0'}}>{item.name || 'Men Fashion'}</h3>
              <div style={{color: '#a21caf', fontWeight: 600, marginBottom: '6px'}}>${item.price || '---'}</div>
              <div style={{marginBottom: '10px'}}>
                <span style={{color: '#fbbf24', fontSize: '1.1rem'}}>★ ★ ★ ★ ☆</span>
                <span style={{color: '#a0aec0', fontSize: '0.9rem', marginLeft: '4px'}}>(54)</span>
              </div>
